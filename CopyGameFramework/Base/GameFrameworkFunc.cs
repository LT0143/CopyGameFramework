...
{
    /// <summary>
    /// 封装一个方法，该方法不具有参数，但却返回TResult参数指定的类型的值。
    /// </summary>
    /// <typeparam name="TResult">此委托封装的方法的返回类型</typeparam>
    /// <returns>此委托封装方法的返回值</returns>
    public delegate TResult GameFramworkFunc<out TResult>();
