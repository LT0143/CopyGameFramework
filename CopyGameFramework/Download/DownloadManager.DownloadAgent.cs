    ...
    internal partial class DownloadManager
    {
        ...
        private sealed class DownloadAgent : ITaskAgent<DownloadTask>, IDisposable
        {
            ...
            public void Update(float elapseSeconds, float realElapseSeconds)
            {
                ...
                {
                    m_WaitTime += realElapseSeconds;      //等待超时
            ...
            public void Start(DownloadTask task)
            {
                ...
                {
                    OnDownloadAgentHelperError(this, new DownloadAgentHelperErrorEventArgs(excepotion.Message));
                }
            }
            ...
            private void OnDownloadAgentHelperComplete(object sender, DownloadAgentHelperCompleteEventArgs args)
            {
                m_WaitTime = 0f;
                byte[] bytes = args.GetBytes();
                SaveBytes(bytes);

                m_DownloadedLength = args.Length;
